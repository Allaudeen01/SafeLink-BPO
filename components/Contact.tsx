      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-2xl shadow-slate-200/50">
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Tell us about your stores</h2>
            <p className="text-slate-600 mb-8">Get accurate weekly hours for your team. Start today.</p>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-medium text-slate-500 mb-1">Store / Company</label>
                ...
                <div>
                   <label className="block text-xs font-medium text-slate-500 mb-1">Number of Stores</label>
                  <select className="w-full bg-slate-50 border border-slate-300 rounded-md px-4 py-2.5 text-slate-900 focus:ring-2 focus:ring-cyan-500 focus:border-transparent outline-none transition-all appearance-none">
                    ...
                    <option>6 - 10 Stores</option>
                    <option>10+ Stores</option>
                  </select>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea rows={3} className="w-full bg-slate-50 border border-slate-300 rounded-md px-4 py-2.5 text-slate-900 focus:ring-2 focus:ring-cyan-500 focus:border-transparent outline-none transition-all placeholder:text-slate-400" placeholder="I need attendance tracking for..."></textarea>
              </div>

              <Button fullWidth size="lg" className="mt-4">Start CCTV Hour Tracking</Button>
            </form>
          ...
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div className="pt-8 border-t border-slate-200">
               <p className="text-slate-600 text-sm italic">
                 "Payroll used to take me 4 hours every Monday. Now SafeLink sends me the Excel sheet and I'm done in 10 minutes."
               </p>
               <p className="mt-2 text-slate-900 font-medium text-sm">— Owner, Multi-Location Shell Franchise</p>
            </div>
          </div>
