...
import mainRegisterImage from '../src/assets/main-register.png?url';
import inventoryImage from '../src/assets/inventory.png?url';
import aisleImage from '../src/assets/aisle-4.png?url';
...
const cameras = [
  {
    ...
    status: "LIVE",
    image: mainRegisterImage // Cashier/Counter view
  },
  {
    id: "CAM-02",
  ...
  },
  {
    ...
    status: "RECORDING",
    image: inventoryImage // Shelves/Stock
  }
];
